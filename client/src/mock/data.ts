// ============================================================
// Client-side mock data — mirrors server/src/data/mockData.ts
// Used for static GitHub Pages deployment (no Express backend).
// ============================================================
...
// The client User type doesn't have email or passwordHash,
// so we extend it locally for auth lookup during static mode.
...
// Pre-populate register data for today + historical data for class attendance tab.
function initRegisters() {
  const today = new Date().toISOString().split('T')[0];
  const g = (n: number) => n as ATLGrade;

  // Simulate P1 already taken for 9B/Ma1 by Ms Harrison (Week A Monday)
  registerStore.set(`sl-a-har-mon-1_${today}`, [
    { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) },
    { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(1) },
    { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null },
    { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
    { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(3) },
    { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
    { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) },
    { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
  ]);

  // Historical data for cls-1 (9B/Ma1) — 10 past lessons
  const cls1: Array<{ lid: string; date: string; entries: RegisterEntry[] }> = [
    { lid: 'sl-a-wil-mon-2', date: '2026-01-12', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
    ]},
    { lid: 'sl-a-wil-tue-2', date: '2026-01-13', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(1) },
      { studentId: 'stu-3', attendanceCode: '/', atlGrade: g(3) }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: 'L', atlGrade: g(2), note: '5 minutes late' },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: '/', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-wed-3', date: '2026-01-14', entries: [
      { studentId: 'stu-1', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-4', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
    ]},
    { lid: 'sl-a-wil-mon-2', date: '2026-01-19', entries: [
      { studentId: 'stu-1', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(1) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: '/', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-tue-2', date: '2026-01-20', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-4', attendanceCode: 'L', atlGrade: g(2), note: '3 minutes late' },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
    ]},
    { lid: 'sl-a-wil-wed-3', date: '2026-01-21', entries: [
      { studentId: 'stu-1', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-4', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '\\', atlGrade: g(3) },
      { studentId: 'stu-7', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-mon-2', date: '2026-01-26', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: 'L', atlGrade: g(2), note: '8 minutes late' },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
    ]},
    { lid: 'sl-a-wil-tue-2', date: '2026-01-27', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(1) },
      { studentId: 'stu-3', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-4', attendanceCode: 'L', atlGrade: g(2), note: '4 minutes late' },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: '/', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-mon-2', date: '2026-02-02', entries: [
      { studentId: 'stu-1', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: 'N', atlGrade: null },
    ]},
    { lid: 'sl-a-wil-tue-2', date: '2026-02-03', entries: [
      { studentId: 'stu-1', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-2', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-3', attendanceCode: 'L', atlGrade: g(2), note: '10 minutes late' }, { studentId: 'stu-4', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-5', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-6', attendanceCode: '/', atlGrade: g(2) },
      { studentId: 'stu-7', attendanceCode: '/', atlGrade: g(2) }, { studentId: 'stu-8', attendanceCode: '/', atlGrade: g(2) },
    ]},
  ];
  for (const l of cls1) registerStore.set(`${l.lid}_${l.date}`, l.entries);

  // Historical data for cls-2 (10C/Ma2) — 8 past lessons
  const cls2: Array<{ lid: string; date: string; entries: RegisterEntry[] }> = [
    { lid: 'sl-a-wil-mon-4', date: '2026-01-12', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-tue-5', date: '2026-01-13', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(1) },
      { studentId: 'stu-11', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: 'L', atlGrade: g(2), note: '7 minutes late' }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-mon-4', date: '2026-01-19', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-tue-5', date: '2026-01-20', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: 'L', atlGrade: g(2), note: '4 minutes late' },
      { studentId: 'stu-13', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-mon-4', date: '2026-01-26', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: '\\', atlGrade: g(3) }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-tue-5', date: '2026-01-27', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(1) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-mon-4', date: '2026-02-02', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: 'N', atlGrade: null }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
    { lid: 'sl-a-wil-tue-5', date: '2026-02-03', entries: [
      { studentId: 'stu-9', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-10', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-11', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-12', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-13', attendanceCode: 'L', atlGrade: g(2), note: '6 minutes late' }, { studentId: 'stu-14', attendanceCode: '\\', atlGrade: g(2) },
      { studentId: 'stu-15', attendanceCode: '\\', atlGrade: g(2) }, { studentId: 'stu-16', attendanceCode: '\\', atlGrade: g(2) },
    ]},
  ];
  for (const l of cls2) registerStore.set(`${l.lid}_${l.date}`, l.entries);
}
initRegisters();
