...
function initRegisters() {
  ...
  registerStore.set(`sl-a-har-mon-1_${today}`, [
    { studentId: 'stu-1', attendanceCode: '/', atlGrade: 2 as ATLGrade },
    { studentId: 'stu-2', attendanceCode: '/', atlGrade: 1 as ATLGrade },
    { studentId: 'stu-3', attendanceCode: 'N', atlGrade: null },
    { studentId: 'stu-4', attendanceCode: '/', atlGrade: 2 as ATLGrade },
    { studentId: 'stu-5', attendanceCode: '/', atlGrade: 3 as ATLGrade },
    { studentId: 'stu-6', attendanceCode: '/', atlGrade: 2 as ATLGrade },
    { studentId: 'stu-7', attendanceCode: '/', atlGrade: 2 as ATLGrade },
